...
const ScrollToTopButton: React.FC = () => {
  ...
  return (
    <button
      ...
      className={`fixed bottom-8 right-8 z-50 w-16 h-16 rounded-full bg-gradient-to-b from-[#3DDAB4] to-[#7A77FF] shadow-lg flex items-center justify-center transition-opacity duration-300 cursor-pointer group ${
